...
const Services = () => {
  ...
  return (
    <section 
      id="projects"
      ref={containerRef}
      className="bg-white pt-24 pb-32 px-6 md:px-12 w-full relative overflow-hidden font-sans bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:80px_80px] scroll-mt-16"
    >
      {/* Ambient Moving Blobs (Blends with the white background grid) */}
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        {/* Soft Red/Crimson glow blob */}
        <div className="absolute top-1/3 left-0 w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-[#ff2a2a]/4 rounded-full filter blur-[100px] md:blur-[140px] animate-blob-1"></div>
        {/* Soft Grey glow blob */}
        <div className="absolute bottom-1/3 right-0 w-[350px] md:w-[600px] h-[350px] md:h-[600px] bg-gray-200/40 rounded-full filter blur-[100px] md:blur-[140px] animate-blob-2"></div>
        {/* Soft Warm/Yellow glow blob */}
        <div className="absolute top-2/3 left-1/4 w-[250px] md:w-[450px] h-[250px] md:h-[450px] bg-red-100/30 rounded-full filter blur-[90px] md:blur-[120px] animate-blob-3"></div>
      </div>
      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px] z-10">
        ...
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          ...
          <p className="text-gray-500 text-base md:text-lg max-w-sm font-medium leading-relaxed">
            A showcase of web applications, IoT solutions, and internships I have completed during my academic journey.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard 
            ...
            text="Tech Volt Software Pvt. Ltd. (Sep 2024). Gained hands-on experience developing full-stack web applications, integrating modern frontends with databases."
          ...
          <TagCard 
            number="02"
            title="Pulse & Temp Logger"
            text="IoT Project. Developed an IoT-based system to monitor and log human pulse rate and body temperature in real time using health sensors for continuous tracking."
          ...
          <TagCard 
            ...
            text="Web Project. Built a campus navigation website using Google Maps API. Guided users across departments, hostels, and blocks with custom routes."
          ...
          <TagCard 
            number="04"
            title="Smart College Guide"
            text="Web App. Developed a recommendation system in React for Tamil Nadu college admissions based on cutoff scores, community, and preferences."
